...
//    	vehDetails.put("modeOfPayment", vehicleAvailJson.getString("isPrepaid"));
		...
		//In case of Rental/Indian, the pickUp loc and return loc are cities rather than regions.
		//So getting ToLocations from droppOff.
    	...
    	vehDetails.put(JSON_PROP_TOCONTINENT, cityInfo.getOrDefault(JSON_PROP_CONTINENT, ""));
    	vehDetails.put(JSON_PROP_TOCOUNTRY, cityInfo.getOrDefault(JSON_PROP_COUNTRY, ""));
    	vehDetails.put(JSON_PROP_TOSTATE, cityInfo.getOrDefault(JSON_PROP_STATE, ""));
    	vehDetails.put(JSON_PROP_TOCITY, cityInfo.getOrDefault(JSON_PROP_VALUE, ""));*/
