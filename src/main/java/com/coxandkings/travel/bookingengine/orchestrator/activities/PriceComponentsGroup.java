...
import com.coxandkings.travel.bookingengine.orchestrator.activities.PriceComponent;
import com.coxandkings.travel.bookingengine.orchestrator.activities.PriceComponentsGroup;
	...
	public void add(String compCode, String compCcy, BigDecimal compAmt) {
		...
		if (prcComp == null) {
			if (idx == -1) {
				...
				PriceComponentsGroup prcCompsList = new PriceComponentsGroup(currCompCode, getComponentCurrency(),
						new BigDecimal(0), isSummation);
