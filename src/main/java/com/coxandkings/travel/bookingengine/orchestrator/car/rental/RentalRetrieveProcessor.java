...
public class RentalRetrieveProcessor implements CarConstants{
	
	private static final Logger logger = LogManager.getLogger(RentalRetrieveProcessor.class);
	...
	private static void getSupplierBookResponseJSON(JSONObject modifyReq, Element resBodyElem,
		...
		vehicleAvailJson.put(JSON_PROP_VEHICLEINFO, RentalSearchProcessor.getVehicleInfo(vehicleElem));
		
		JSONObject pricingInfo = RentalSearchProcessor.getPricingInfoJSON(vehSegCoreElem, vehSegInfoElem);
