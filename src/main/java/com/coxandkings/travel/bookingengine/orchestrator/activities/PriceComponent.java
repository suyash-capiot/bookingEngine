...
public class PriceComponent implements ActivityConstants {
	...
	public boolean isMatching(String compCode) {
		...
		String[] compCodeParts = compCode.split("@");
		return (mCompCode.equals(compCodeParts[0])
				&& ((mCompName == null && compCodeParts.length <= 1) || mCompName.equals(compCodeParts[1])));
	}
