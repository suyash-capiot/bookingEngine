package com.coxandkings.travel.bookingengine.config.visa;
...
public class VisaConfig implements Constants {
	...
	public static void loadConfig() {
		...
		Document configDoc = MongoProductConfig.getConfig("VISA");
