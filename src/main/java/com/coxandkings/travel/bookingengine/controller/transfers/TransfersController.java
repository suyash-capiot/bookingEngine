...
import com.coxandkings.travel.bookingengine.orchestrator.transfers.OpsUtility;
...
import com.coxandkings.travel.bookingengine.orchestrator.transfers.TransfersSearchAsyncProcessor;
import com.coxandkings.travel.bookingengine.utils.Utils;

@CrossOrigin(origins = "*")
@RestController
@RequestMapping("/TransfersService/v1")
public class TransfersController {
	...
	public ResponseEntity<String> lowfareSearch(JSONObject reqJson) throws Exception {
		String res = TransfersSearchAsyncProcessor.process(reqJson);
	...
	public ResponseEntity<String> book(JSONObject reqJson) throws Exception {
		...
		return new ResponseEntity<String>(TransfersBookProcessor.process(reqJson), HttpStatus.OK);
	}
	...
	public ResponseEntity<String> cancel(JSONObject reqJson) throws Exception {
		String res = TransfersCancelProcessor.process(reqJson);
		return new ResponseEntity<String>(TransfersCancelProcessor.process(reqJson), HttpStatus.OK);
	}
