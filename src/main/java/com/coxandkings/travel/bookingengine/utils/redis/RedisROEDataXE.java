...
public class RedisROEDataXE  implements Constants{

	private static final Logger logger = LogManager.getLogger(RedisROEDataXE.class);
	private static final String REDIS_KEY_ROEDATA = "be:common:roe";


	
	
	public static boolean insertDailyROEData(JSONObject roeJson) {
		
		JSONArray roeArr = getROEData("Daily ROE",roeJson);
	...
	private static JSONArray getROEData(String roeType, JSONObject roeJson) {

		long startTime = System.currentTimeMillis();
		JSONArray data = roeJson.optJSONArray("data");
